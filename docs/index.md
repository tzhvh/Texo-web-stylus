...
**Generated:** 2025-11-22 (Updated from 2025-11-13)
...
- **[Project Overview](./project-overview.md)** - Executive summary, technology stack, and architecture highlights
- **[Source Tree Analysis](./source-tree-analysis.md)** - Complete annotated directory structure with critical folders
...
2. **Understanding the Codebase:**
   ...
   - [Source Tree Analysis](./source-tree-analysis.md) - File organization
...
2. **For Specific Tasks:**
   ...
   - **State Management:** State Management doc for data flow patterns
...
texo-web-stylus/
├── src/
│   ├── App.jsx                    # Main router with 5 pages
...
│   │   └── MagicCanvas.jsx       # Row-based canvas system
...
### Component-Based SPA
- **Router:** React Router v7 with 5 main pages
...
| 2025-11-22 | 2.0.0 | Full rescan with updated analysis and enhanced documentation |
